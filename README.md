<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=11998e,38ef7d,0575e6&height=280&section=header&text=ChemLLM%20Adapter&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Generative%20AI%20for%20Molecular%20Toxicity&descAlignY=60&descAlign=50" width="100%"/>
...
graph LR
    subgraph Data Pipeline
        A[🧪 Tox21 Raw Data] -->|RDKit Validation| B(SMILES Tokenizer)
        B -->|Prompt Engineering| C{Tensor Batches}
    end
    
    subgraph LLM Core
        D[🤖 OLMo-7B Base] -->|Freeze Weights| E[4-bit Quantization]
        E -->|Inject| F[LoRA Adapters (r=32)]
    end
    
    subgraph Training Loop
        C -->|Feed| F
        F -->|Backprop| G[🚀 Fine-Tuned Bio-Model]
    end
    
    style F fill:#00C853,stroke:#fff,stroke-width:2px,color:#fff
    style D fill:#222,stroke:#fff,stroke-width:2px,color:#fff
    style B fill:#0575e6,stroke:#fff,stroke-width:2px,color:#fff
